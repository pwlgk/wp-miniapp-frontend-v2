  ...
  return (
    <div className="bg-main-bg">
      ...
      <div className="p-4 space-y-8">
        ...
        {/* --- БЛОК "КАК ОФОРМИТЬ" --- */}
        <div className="space-y-4">
  <h2 className="text-2xl font-bold text-center">Как оформить заказ</h2>
  <div className="space-y-4">
    <HowToStep number={1} text="1. Откройте каталог и добавьте понравившиеся позиции в корзину." />
    <HowToStep number={2} text="2. Перейдите в корзину, проверьте состав заказа и нажмите «Оформить». Заполните форму с контактными данными." />
    <HowToStep number={3} text="3. Мы свяжемся с вами в Telegram, уточним детали и подтвердим заказ." />
    <HowToStep number={4} text="4. После подтверждения заказа пришлём реквизиты для оплаты (доставка рассчитывается отдельно)." />
    <HowToStep
      number={5}
    ...
    <HowToStep
      number={5}
      text="При другом способе — передадим заказ в службу доставки в течение 1–2 рабочих дней и вышлем трек-номер."
    />
  </div>
</div>
