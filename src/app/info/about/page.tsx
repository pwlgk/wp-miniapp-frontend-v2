      ...
      <div className="p-4 space-y-8">
        ...
        <div className="p-6 bg-white rounded-2xl shadow-sm">
          <div className="prose prose-sm max-w-none">
            <h2>О нас</h2>
            <p>
              <strong>Kosynka Store</strong> — это уютное пространство, созданное с любовью к красоте, скромности и стилю. Наш магазин вырос из личного стремления найти элегантные и удобные аксессуары, которые подчеркивают женственность, оставаясь верными традициям. Мы тщательно подбираем каждую позицию в ассортименте, чтобы вы могли легко подобрать изделие как для особого случая, так и для повседневной жизни. <strong>Kosynka Store</strong> — это не просто место покупок, а отражение ценностей заботы, честности и стремления делать мир немного прекраснее.
            </p>
